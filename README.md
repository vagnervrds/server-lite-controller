...
### em caso de problemas com o psutil
Se estiver retornando dados vazios ou nulo tente instalar essas dependencias no sistema, instalei tudo então sei exatametne o que funcionou, se possive instale individualmente e me diga o que funcionou no seu caso
`sudo apt update && sudo apt install -y smartmontools hdparm iotop nethogs lshw hwinfo net-tools iftop`
