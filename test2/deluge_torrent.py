...
@app.route('/stop/<torrent_id>', methods=['POST'])
...
@app.route('/cancel/<torrent_id>', methods=['POST'])
...
@app.route('/delete/<torrent_id>', methods=['POST'])
...
@app.route('/list-files/<torrent_id>', methods=['GET'])
